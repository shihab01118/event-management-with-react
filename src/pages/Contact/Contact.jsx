    ...
    <div className="max-w-6xl mx-8 md:mx-16 lg:mx-auto my-10">
      <div className="md:flex">
        <div className="md:w-1/2 space-y-4">
          <h2 className="text-3xl font-bold text-center md:text-left text-[#0B0B0B]">Contact Information</h2>
          <div className="flex gap-4 items-center">
            <LiaHeadsetSolid className="text-3xl text-[#0B0B0B]"></LiaHeadsetSolid>
            <div>
              <h4 className="text-xl font-medium text-[#0B0B0B]">Exploration Call</h4>
          ...
          <div className="flex gap-4 items-center">
            ...
            <div>
              <h4 className="text-xl font-medium text-[#0B0B0B]">Email Info</h4>
        ...
        <div className="md:w-1/2 mt-5 md:mt-0">
          <h2 className="text-3xl font-bold mb-2 text-center md:text-left text-[#0B0B0B]">Get In Touch</h2>
